...
(check-equal? (advance-game-tank (make-game empty empty (make-tank (/ WIDTH 2) -1))) (make-game empty empty (make-tank (- (/ WIDTH 2) TANK-SPEED) -1)))
(check-equal? (advance-game-tank (make-game (list I1) (list M1) (make-tank (/ WIDTH 2) -1))) (make-game (list I1) (list M1) (make-tank (- (/ WIDTH 2) TANK-SPEED) -1)))
(check-equal? (advance-game-tank (make-game (list I1 I2) (list M1 M2) (make-tank (/ WIDTH 2) 1))) (make-game (list I1 I2) (list M1 M2) (make-tank (+ (/ WIDTH 2) TANK-SPEED) 1)))
(check-equal? (advance-game-tank (make-game (list I1 I2) (list M1 M2) (make-tank TANK-WIDTH/2 -1))) (make-game (list I1 I2) (list M1 M2) (make-tank TANK-WIDTH/2 -1)))
(check-equal? (advance-game-tank (make-game (list I1 I2) (list M1 M2) (make-tank TANK-WIDTH/2 1))) (make-game (list I1 I2) (list M1 M2) (make-tank (+ TANK-WIDTH/2 TANK-SPEED) 1)))
(check-equal? (advance-game-tank (make-game (list I1 I2) (list M1 M2) (make-tank (- WIDTH TANK-WIDTH/2) 1))) (make-game (list I1 I2) (list M1 M2) (make-tank (- WIDTH TANK-WIDTH/2) 1)))
(check-equal? (advance-game-tank (make-game (list I1 I2) (list M1 M2) (make-tank (- WIDTH TANK-WIDTH/2) -1))) (make-game (list I1 I2) (list M1 M2) (make-tank (- (- WIDTH TANK-WIDTH/2) TANK-SPEED) -1)))
...
(check-equal? (advance-game-missiles (make-game empty empty T0)) (make-game empty empty T0))
(check-equal? (advance-game-missiles (make-game (list I1 I2) empty T0)) (make-game (list I1 I2) empty T0))
(check-equal? (advance-game-missiles (make-game (list I1 I2)
                                                (list (make-missile 0 HEIGHT) (make-missile 0 0))
                                                T0))
              (make-game (list I1 I2) (list (make-missile 0 (- HEIGHT MISSILE-SPEED)) (make-missile 0 (- 0 MISSILE-SPEED))) T0))
...
(check-equal? (filter-game-missiles (make-game empty empty T0)) (make-game empty empty T0))
(check-equal? (filter-game-missiles (make-game (list I1 I2) empty T0)) (make-game (list I1 I2) empty T0))
(check-equal? (filter-game-missiles (make-game (list I1 I2) (list (make-missile 0 HEIGHT)) T0)) (make-game (list I1 I2) (list (make-missile 0 HEIGHT)) T0))
(check-equal? (filter-game-missiles (make-game (list I1 I2) (list (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y)) T0))
              (make-game (list I1 I2) (list (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y)) T0))
(check-equal? (filter-game-missiles (make-game (list I1 I2) (list (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y) (make-missile 0 (- MISSILE-OUTSIDE-OF-SCREEN-Y 1))) T0))
              (make-game (list I1 I2) (list (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y)) T0))
(check-equal? (filter-game-missiles (make-game (list I1 I2) (list (make-missile 0 HEIGHT) (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y) (make-missile 0 (- MISSILE-OUTSIDE-OF-SCREEN-Y 1))) T0))
              (make-game (list I1 I2) (list (make-missile 0 HEIGHT) (make-missile 0 MISSILE-OUTSIDE-OF-SCREEN-Y)) T0))
...
(check-equal? (explode-game-objects (make-game empty empty T0)) (make-game empty empty T0))
(check-equal? (explode-game-objects (make-game (list (make-invader 150 300 0)) empty T0)) (make-game (list (make-invader 150 300 0)) empty T0))
(check-equal? (explode-game-objects (make-game empty (list (make-missile 150 300)) T0)) (make-game empty (list (make-missile 150 300)) T0))
(check-equal? (explode-game-objects (make-game (list (make-invader 0 0 0) (make-invader 10 10 0) (make-invader 100 100 100))
                                               (list (make-missile 150 300) (make-missile 250 350) (make-missile 109 105)) T0))
              (make-game (list (make-invader 0 0 0) (make-invader 10 10 0))
...
(check-equal? (explode-game-invaders (make-game empty empty T0)) empty)
(check-equal? (explode-game-invaders (make-game (list (make-invader 150 300 0)) empty T0)) (list (make-invader 150 300 0)))
(check-equal? (explode-game-invaders (make-game empty (list (make-missile 150 300)) T0)) empty)
(check-equal? (explode-game-invaders (make-game (list (make-invader 0 0 0) (make-invader 10 10 0) (make-invader 100 100 100))
                                                (list (make-missile 150 300) (make-missile 250 350) (make-missile 109 105)) T0))
...
;(define (invader-hit-missiles? i lom) false ) ; stub
(check-equal? (explode-game-missiles (make-game empty empty T0)) empty)
(check-equal? (explode-game-missiles (make-game (list (make-invader 150 300 0)) empty T0)) empty)
(check-equal? (explode-game-missiles (make-game empty (list (make-missile 150 300)) T0)) (list (make-missile 150 300)))
(check-equal? (explode-game-missiles (make-game (list (make-invader 0 0 0) (make-invader 10 10 0) (make-invader 100 100 100))
                                                (list (make-missile 150 300) (make-missile 250 350) (make-missile 109 105)) T0))
...
(check-random-equal? (spawn-new-game-invaders (make-game empty empty T1)) (make-game (spawn-new-invader-randomly empty) empty T1))
(check-random-equal? (spawn-new-game-invaders (make-game empty (list M1 M2) T1)) (make-game (spawn-new-invader-randomly empty) (list M1 M2) T1))
(check-random-equal? (spawn-new-game-invaders (make-game (list I1 I2) (list M1 M2) T1)) (make-game (spawn-new-invader-randomly (list I1 I2)) (list M1 M2) T1))
...
(check-equal? (advance-game-invaders (make-game empty empty T1)) (make-game empty empty T1))
(check-equal? (advance-game-invaders (make-game empty (list M1 M2) T1)) (make-game empty (list M1 M2) T1))
(check-equal? (advance-game-invaders (make-game
                                      (list (make-invader INVADER-WIDTH/2 0 1) (make-invader 0 0 0))
                                      (list M1 M2)
                                      T1))
              (make-game (list (make-invader (+ INVADER-WIDTH/2 (* 1 INVADER-X-SPEED)) (+ 0 (* (abs 1) INVADER-Y-SPEED)) 1) (make-invader 0 0 0))
                         (list M1 M2)
                         T1))
(check-equal? (advance-game-invaders (make-game
                                      ...
                                      (list M1 M2)
                                      T1))
              (make-game (list (make-invader (+ INVADER-WIDTH/2 (* 1 INVADER-X-SPEED)) (+ 0 (* (abs 1) INVADER-Y-SPEED)) 1) (make-invader (+ (- WIDTH INVADER-WIDTH/2) (* -1 INVADER-X-SPEED)) (+ 0 (* (abs 1) INVADER-Y-SPEED)) -1))
                         (list M1 M2)
                         T1))
...
(check-equal? (advance-game-state (make-game empty empty (make-tank (/ WIDTH 2) 1))) (make-game empty empty (make-tank (+ (/ WIDTH 2) TANK-SPEED) 1)))
(check-equal? (advance-game-state (make-game empty (list (make-missile (/ WIDTH 2) (/ HEIGHT 2))) (make-tank (/ WIDTH 2) 1)))
              (make-game empty (list (make-missile (/ WIDTH 2) (- (/ HEIGHT 2) MISSILE-SPEED))) (make-tank (+ (/ WIDTH 2) TANK-SPEED) 1)))
(check-equal? (advance-game-state (make-game (list (make-invader (/ WIDTH 2) (/ HEIGHT 2) 1)) (list (make-missile (/ WIDTH 2) 0)) (make-tank (/ WIDTH 2) 1)))
              (make-game (list (make-invader (+ (/ WIDTH 2) (* 1 INVADER-X-SPEED)) (+ (/ HEIGHT 2) (* 1 INVADER-Y-SPEED)) 1)) empty (make-tank (+ (/ WIDTH 2) TANK-SPEED) 1)))
...
(check-equal? (terminate-game? (make-game empty empty T0)) false)
(check-equal? (terminate-game? (make-game (list (make-invader 0 0 10)) empty T0)) false)
(check-equal? (terminate-game? (make-game (list (make-invader 0 HEIGHT -10) (make-invader 0 0 10)) empty T0)) true)
(check-equal? (terminate-game? (make-game (list (make-invader 0 0 -10) (make-invader 0 HEIGHT 10)) empty T0)) true)
(check-equal? (terminate-game? (make-game (list (make-invader 0 0 -10) (make-invader 0 HEIGHT 10) (make-invader 0 0 -10)) (list M2) T0)) true)
(check-equal? (terminate-game? (make-game (list (make-invader 0 0 -10) (make-invader 0 0 11) (make-invader 0 HEIGHT 12)) (list M1) T0)) true)
...
(check-equal? (control-game G0 "left") (make-game (game-invaders G0) (game-missiles G0) (make-tank (tank-x (game-tank G0)) -1)))
(check-equal? (control-game G3 "left") (make-game (game-invaders G3) (game-missiles G3) (make-tank (tank-x (game-tank G3)) -1)))
(check-equal? (control-game G0 "right") (make-game (game-invaders G0) (game-missiles G0) (make-tank (tank-x (game-tank G0)) 1)))
(check-equal? (control-game G3 "right") (make-game (game-invaders G3) (game-missiles G3) (make-tank (tank-x (game-tank G3)) 1)))
(check-equal? (control-game G0 " ") (make-game (game-invaders G0)
                                               (cons (make-missile (tank-x (game-tank G0)) TANK-MISSILE-LAUNCHER-Y) (game-missiles G0))
                                               (game-tank G0)))
(check-equal? (control-game G3 " ") (make-game (game-invaders G3)
...
(check-equal? (update-tank-direction (make-game empty empty (make-tank 0 -1)) -1) (make-game empty empty (make-tank 0 -1)))
(check-equal? (update-tank-direction (make-game empty empty (make-tank 0 -1))  1) (make-game empty empty (make-tank 0  1)))
(check-equal? (update-tank-direction (make-game empty empty (make-tank 0  1))  1) (make-game empty empty (make-tank 0  1)))
(check-equal? (update-tank-direction (make-game empty empty (make-tank 0  1)) -1) (make-game empty empty (make-tank 0 -1)))
(check-equal? (update-tank-direction G3 -1) (make-game (game-invaders G3) (game-missiles G3) (make-tank (tank-x (game-tank G3)) -1)))
(check-equal? (update-tank-direction G3 1) (make-game (game-invaders G3) (game-missiles G3) (make-tank (tank-x (game-tank G3)) 1)))
...
(check-equal? (fire-missile (make-game empty empty (make-tank 0 -1))) (make-game empty (list (make-missile 0 TANK-MISSILE-LAUNCHER-Y)) (make-tank 0 -1)))
(check-equal? (fire-missile (make-game (list (make-invader 100 100 10)) empty (make-tank 0 -1)))
              (make-game (list (make-invader 100 100 10))
                         (list (make-missile 0 TANK-MISSILE-LAUNCHER-Y))
                         (make-tank 0 -1)))
(check-equal? (fire-missile
               (make-game (list (make-invader 100 100 10) (make-invader 200 200 -20))
